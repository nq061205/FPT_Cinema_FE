...
function ProfilePage() {
  ...
  return (
    <section className="page-stack">
      <PageHeader eyebrow="Account" title="Profile" description="Read and edit the authenticated user profile." />
      ...
      <div className="grid-two">
        <form className="panel form-grid" onSubmit={handleProfileSubmit}>
          ...
          <button className="btn btn-danger" type="submit">Save profile</button>
        </form>
